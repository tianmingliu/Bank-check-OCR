...
from src.main.backend.data_extraction.field.amount_field import AmountField
from src.main.backend.data_extraction.field.data.field_data import FieldData, FieldType

"""
This class test the AmountField class
...
class AmountTest(unittest.TestCase):
    ...
    def test_not_digit_or_written_amount(self):
        ...
        test_pair.field_type = FieldType.FIELD_TYPE_AMOUNT
        test_pair.extracted_data = "aslkdj sldg hsld"
        self.assertEqual(test_amount_field_class.validate(test_pair), False)
    ...
    def test_amount_valid(self):
        ...
        self.assertEqual(test_amount_field_class.validate(test_pair), True)
    ...
    def test_written_amount_valid(self):
        ...
        test_pair.field_type = FieldType.FIELD_TYPE_AMOUNT
        test_pair.extracted_data = "One hundred fifty and 0/100"
        self.assertEqual(test_amount_field_class.validate(test_pair), True)
