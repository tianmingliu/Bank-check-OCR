...
from backend.data_extraction.handwriting_extract.src.SamplePreprocessor import preprocessor
...
class FilePaths:
    ...
    fnCharList = os.path.join(filedir, '../model/charList.txt')
    fnWordCharList = os.path.join(filedir, '../model/wordCharList.txt')
    fnCorpus = os.path.join(filedir, '../data/corpus.txt')
    fnAccuracy = os.path.join(filedir, '../model/accuracy.txt')
    fnTrain = os.path.join(filedir, '../data/')
    fnInfer = os.path.join(filedir, '../data/testImage.png')  # path to recognize the single image
