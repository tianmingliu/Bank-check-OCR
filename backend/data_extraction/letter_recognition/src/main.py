...
from backend.data_extraction.letter_recognition.src.Model import DecoderType, Model
from backend.data_extraction.letter_recognition.src.SpellChecker import correct_sentence
...
def extract(image):
    ...
    filename = os.path.join(filedir, 'image.png')
